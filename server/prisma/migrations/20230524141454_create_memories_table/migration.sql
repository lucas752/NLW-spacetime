/*
  ...
  - A unique constraint covering the columns `[githudId]` on the table `User` will be added. If there are existing duplicate values, this will fail.
...
ADD COLUMN     "githudId" INTEGER NOT NULL,
